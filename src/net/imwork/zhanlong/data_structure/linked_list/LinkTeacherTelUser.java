 ...
 * @author 展龙
 */
public class LinkTeacherTelUser
{
    public static void main(String[] args) throws IOException
    {
        LinkTeacherTel linkTeacherTel = new LinkTeacherTel();
        ...
        while (true)
        {
            ...
            switch (choice)
            {
                ...
                case 1:
                    ...
                    linkTeacherTel.add(teacherNode);
                    System.out.println();
                    break;
                case 2:
                    linkTeacherTel.listAll();
                    System.out.println();
                    break;
                case 3:
                    System.out.print("\n请输入教师编号：");
                    int teacherNo = Integer.parseInt(br.readLine());
                    linkTeacherTel.search(teacherNo);
                    System.out.println();
                    break;
                case 4:
                    System.out.println("教师电话记录个数为： " + linkTeacherTel.getCounts());
                    break;
                case 5:
                    System.out.println("请输入要删除记录的教师编号：");
                    int teacherId = Integer.parseInt(br.readLine());
                    linkTeacherTel.delete(teacherId);
                    System.out.println();
                    break;
                case 6:
                    System.out.println("请输入要查询记录的教师姓名：");
                    String name1 = br.readLine();
                    linkTeacherTel.delete(name1);
                    System.out.println();
                    break;
                case 7:
                    System.out.println("请输入要删除的教师姓名：");
                    String name = br.readLine();
                    linkTeacherTel.delete(name);
                    System.out.println();
                    break;
                default:
            }
